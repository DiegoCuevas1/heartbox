            ...
            <div className="flex items-center space-x-2 px-4">
                ...
                <div className="flex-col space-y-0">
                    <div className="flex space-x-24">
                        <h2 className="pt-3 font-loves font-bold">{post.user_details.first_name} {post.user_details.last_name}</h2>
                        <p className="border-2 border-[#d31c60] rounded-full px-2 mt-3 font-loves font-bold ">{post.post_details.datePosted}</p>
                    </div>
