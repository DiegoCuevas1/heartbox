                ...
                <div className="flex items-center">
                    ...
                    <div id="main-menu-id" ref={menuRef} className="z-[1000] fixed top-[112px] flex-col right-0 w-[190px] text-white shadow-xl rounded-bl-sm  flex bg-[#fbd1d1]">
                        ...
                        <div className="mt-4 ml-10 pb-4">
                            <button className="flex space-x-2 py-1 px-5 rounded-sm text-white drop-shadow-xl font-loves font-bold text-xl bg-[#d31c60] hover:cursor-pointer hover:bg-[#ee80a9] active:scale-95 transition-all" onClick={toggleMenu}><Link href={'/auth/sign-in'}>SIGN IN</Link></button>
                        </div>
                        }
