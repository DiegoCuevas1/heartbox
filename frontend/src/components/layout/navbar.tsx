        ...
        <nav>
            <div className="flex fixed z-[1000] w-screen px-8 justify-between items-center h-28 bg-gradient-to-l from-[#f4a7a7] via-[#f9c0c1] to-[#f4a7a7]">
                <div>
                    ...
                    {isProfileMenuOpen && (
                    <div id="profile-menu-id" className="z-[1000] fixed border-r-2 border-b-2 border-black top-[112px] left-0 w-[190px] rounded-br-[25px] z-[1000] text-white h-[335px] flex bg-[#268874]">
                ...
                <div className="flex items-center">
                    ...
                    {isMenuOpen && (
                    <div id="main-menu-id" className="z-[1000] fixed top-[112px] right-0 w-[190px] z-[1000] text-white border-black border-l-2 border-b-2 rounded-bl-[25px] h-[200px] flex bg-[#268874]">
