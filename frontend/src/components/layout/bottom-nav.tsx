...
const BottomNavBar = () => {
  ...
  return(
    <div className="flex w-screen h-24 bg-[#F8B7B7]  fixed bottom-0 z-[1] justify-around items-center ">
        ...
        <Link href={"/families"}><Image src="https://dev-heartbox.s3.us-east-2.amazonaws.com/family_pics/families.png" width={55} height={55} alt="Heartbox Home Page Logo" /></Link>
        ...
        <Link href="/profile">
          {profilePic ? (
            ...
            <Image
              src={`https://dev-heartbox.s3.us-east-2.amazonaws.com/profile_pics/default_profpic.png`}
              width={50}
              height={50}
              alt="Heartbox Home Page Logo"
            />
